const data = {
    ...
    ecnomyTrend: {
        ...
        series: [
            {
                name: '工业总产值',
                data: [100, 120, 151, 122, 88, 77, 66, 100, 120, 151, 142, 188, 77, 166, 138]
            },
            {
                name: '增加值',
                data: [122, 88, 77, 100, 120, 151, 66, 100, 120, 151, 122, 128, 177, 126, 158]
            },
            {
                name: '实缴税费总额',
                data: [77, 66, 100, 120, 151, 122, 88, 100, 120, 151, 122, 98, 207, 98, 138]
            },
            {
                name: '固定资产投资',
